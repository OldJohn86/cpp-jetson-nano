...
# 1. Install ROS
git clone git@github.com:OldJohn86/installROS-1.git


# 2. Install Librealsense
git clone git@github.com:OldJohn86/installLibrealsense-1.git


# 3. Install RealSenseSDK
git clone git@github.com:OldJohn86/installRealSenseSDK.git
